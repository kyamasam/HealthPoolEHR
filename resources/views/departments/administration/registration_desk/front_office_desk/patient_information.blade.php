...
<div class="card"> 
        <div class="card-header">
            <h4>PATIENT INFORMAT0ION REPORT</h4>
        </div>
        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="container">
                                    ...
                                    <div class="col-md-12 align-self-center text-center">
                                        ...
                                        <form action="{{ route('patient_information_post') }}" method="post" >
                                            {!! csrf_field() !!}
                                                ...
                                                <div class="form-group row ">
                                                        ...
                                                        <div class="col-sm-6">
                                                        <input type="radio" placeholder="" name="married" value="single">Single<br>
                                                    <input type="radio" placeholder="" name="married" value="married">Married<br>
                                                </div>
                                                </div>
                                                <div class="form-group row ">
                                                        <label for="staticEmail" class="col-sm-3 col-form-label">COMPANY:</label>
                                                         <div class="col-sm-6">
                                                        <input type="radio" value="self" name="company">Self<br>
