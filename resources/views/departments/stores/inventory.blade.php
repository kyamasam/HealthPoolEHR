            ...
            <div class="table-responsive">
                <table id="datatable" class="table table-bordered">
                    ...
                    @if(isset($inventory_results))
                        @foreach($inventory_results as $inventory_results)
                            <tr>
                                <td>{{ $inventory_results->item_code }}</td>
                                <td>{{ $inventory_results->item_name }}</td>
                                <td>{{ $inventory_results->quantity }}</td>
                                <td>{{ $inventory_results->expiry_date }}</td>
                            </tr>
                            @endforeach
                            @endif
                            </tr>
                                ...
                                <div class="container">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <form class="col-m-3 offset-md-3" action="{{route('inventory_post')}}" method="post" >{!! csrf_field() !!}
                                                <H3 class="mt-20 ">
                                                    INVENTORY
                                                </H3>
                                                ...
                                                <div class="form-group row ">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="name" name="item_name" class="form-control" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group row ">
