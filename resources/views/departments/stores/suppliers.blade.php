                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="col-m-3 offset-md-3">
                                                <form action="{{route('suppliers_post')}}" method="post" >{!! csrf_field() !!}
                                                    <h3 class="mt-20 ">
                                                        INVENTORY
                                                    </h3>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input name="vendor_code" type="text" name="" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row ">
                                                        <label for="staticEmail" class="col-sm-3 col-form-label">VENDOR NAME:</label>
                                                        <div class="col-sm-6">
                                                            <input name="vendor_name" type="name" name="" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row ">
                                                        <label for="staticEmail" class="col-sm-3 col-form-label">CATEGORY:</label>
                                                        <div class="col-sm-6">
                                                            <input name="category" type="text" name="" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row ">
                                                        <label for="staticEmail" class="col-sm-3 col-form-label">APPROVAL:</label>
                                                        <div class="col-sm-6">
                                                            <input name="approval" type="text" name="" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
