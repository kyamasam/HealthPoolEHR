...
class CreateStoresPurchaseVendorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stores_purchase_vendors', function (Blueprint $table) {
            $table->increments('id');
            $table->string('type');
            $table->string('name');
    ...
    {
        Schema::dropIfExists('stores_purchase_vendors');
    }
}
