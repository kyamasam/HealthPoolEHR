...
class CreateStoresPurchaseProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stores_purchase_products', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('stores_purchase_products');
    }
}
